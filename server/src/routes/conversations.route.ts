...
class ConversationRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/:id/message`, authMiddleware, this.conversationsController.getMessages)
    this.router.post(`${this.path}`, authMiddleware, validationMiddleware(CreateConversationDto, 'body'), this.conversationsController.getConversations)
